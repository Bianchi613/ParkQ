...
export class PagamentoRepository {
  constructor(@InjectModel(Pagamento) private readonly pagamentoModel: typeof Pagamento) {}
  ...
  async update(id: number, data: Partial<Pagamento>): Promise<[number, Pagamento[]]> {
    return await this.pagamentoModel.update(data, { where: { id }, returning: true });
  }
