...
export class PlanoTarifacaoService {
  ...
  async create(planoTarifacaoData: Partial<PlanoTarifacao>): Promise<PlanoTarifacao> {
    return this.planoTarifacaoRepository.create(planoTarifacaoData);
  }

  async update(id: number, planoTarifacaoData: Partial<PlanoTarifacao>): Promise<PlanoTarifacao> {
  ...
  async calcularTarifa(tipoVaga: string, duracao: number, planoId: number): Promise<number> {
    return this.planoTarifacaoRepository.calcularTarifa(tipoVaga, duracao, planoId);
  }
}
