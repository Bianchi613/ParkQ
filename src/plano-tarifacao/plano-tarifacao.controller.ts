...
export class PlanoTarifacaoController {
  ...
  @ApiResponse({ status: 200, description: 'Lista de planos de tarifação retornada com sucesso.' })
  ...
  @ApiResponse({ status: 404, description: 'Plano de tarifação não encontrado.' })
  ...
  @ApiResponse({ status: 201, description: 'Plano de tarifação criado com sucesso.' })
  ...
  @ApiParam({ name: 'id', description: 'ID do plano de tarifação' })
  @ApiResponse({ status: 200, description: 'Plano de tarifação atualizado com sucesso.' })
  @ApiResponse({ status: 404, description: 'Plano de tarifação não encontrado.' })
  @ApiBody({
    schema: {
      example: {
  ...
  @ApiParam({ name: 'id', description: 'ID do plano de tarifação' })
  @ApiResponse({ status: 204, description: 'Plano de tarifação excluído com sucesso.' })
  @ApiResponse({ status: 404, description: 'Plano de tarifação não encontrado.' })
  ...
  @ApiOperation({ summary: 'Calcula a tarifa com base na duração e no tipo de vaga' })
  @ApiParam({ name: 'id', description: 'ID do plano de tarifação' })
