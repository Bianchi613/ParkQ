...
export class EstacionamentoController {
  ...
  @ApiResponse({ status: 201, description: 'Estacionamento criado com sucesso.' })
  ...
  @ApiParam({ name: 'id', description: 'ID do estacionamento' })
  @ApiResponse({ status: 200, description: 'Estacionamento atualizado com sucesso.' })
  @ApiResponse({ status: 404, description: 'Estacionamento não encontrado.' })
  @ApiBody({
    schema: {
      example: {
  ...
  @ApiParam({ name: 'id', description: 'ID do estacionamento' })
  @ApiResponse({ status: 204, description: 'Estacionamento excluído com sucesso.' })
  @ApiResponse({ status: 404, description: 'Estacionamento não encontrado.' })
  ...
  @ApiParam({ name: 'id', description: 'ID do estacionamento' })
  @ApiResponse({ status: 200, description: 'Monitoramento de vagas realizado com sucesso.' })
  @ApiResponse({ status: 404, description: 'Estacionamento não encontrado.' })
