...
export class OperacaoService {
  ...
  async create(descricao: string, data_hora: Date, id_usuario: number): Promise<Operacao> {
    try {
      return await this.operacaoRepository.create(descricao, data_hora, id_usuario);
    } catch (error) {
  ...
  async update(id: number, descricao: string, data_hora: Date, id_usuario: number): Promise<Operacao> {
    try {
      return await this.operacaoRepository.update(id, descricao, data_hora, id_usuario);
    } catch (error) {
